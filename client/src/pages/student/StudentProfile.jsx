        ...
        <div className="flex flex-col md:flex-row items-center md:items-start p-6 gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-300">
              <p>
                <span className="text-muted">📧 Email:</span> {studentData.email}
              </p>
              <p>
                <span className="text-muted">🎓 Roll No:</span> {studentData.rollNo}
              </p>
              <p>
                <span className="text-muted">📘 Course:</span> {studentData.course}
              </p>
              <p>
                <span className="text-muted">📅 Semester:</span> {studentData.semester}
              </p>
              <p>
                <span className="text-muted">🕓 Joined:</span> {studentData.joined}
              </p>
            </div>
            <div className="mt-6">
